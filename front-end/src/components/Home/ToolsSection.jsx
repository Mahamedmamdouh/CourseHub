...
export default function ToolsSection() {
   ...
   return (
   <div className="flex flex-col items-center justify-center min-h-screen bg-white p-10 gap-10">
  
<div 
        className="text-center max-w-3xl mx-auto space-y-2"
        style={{ fontFamily: "'Lexend', sans-serif" }}
      >
        <h2 className="text-black font-semibold text-xl md:text-4xl tracking-tight leading-tight">
          "Tools of the Trade, Skills for the Market."
        </h2>
        
        <p className="text-black font-semibold text-xl md:text-4xl tracking-tight leading-snug">
          We don't just teach software we teach you how to use <br className="hidden md:block" />
          <span className="gradient-text"> (Photoshop & Illustrator & Indesign) </span> <br className="hidden md:block" />
          to deliver world-class results that clients are eager to pay for."
        </p>
      </div>
